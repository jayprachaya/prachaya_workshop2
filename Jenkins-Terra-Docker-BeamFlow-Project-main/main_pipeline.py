...
table_spec = (
    'just-effect-437502-v4:'
    'prachaya_workshop2.prachaya_dfsqltable_sales'
)
...
pipeline_args = [
    '--project=just-effect-437502-v4',  # Change to your GCP project ID
    '--runner=DataflowRunner',
    '--region=us-central1',  # Adjust as per your GCP region
    '--staging_location=gs://prachaya_workshop2/temp/staging/',  # Change to your bucket path
    '--temp_location=gs://prachaya_workshop2/temp',  # Change to your bucket path
    '--streaming',
...
(p 
 | 'Read from PubSub' >> beam.io.ReadFromPubSub(
     topic="projects/just-effect-437502-v4/topics/prachaya-transactions"  # Change to your PubSub topic
 )
